      ...
      <div className="px-3 py-2">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-200 bg-gray-50 py-2 pl-9 pr-3 text-sm outline-none transition-colors focus:border-green-300 focus:bg-white"
          />
        </div>
      </div>
